<?php
  $pdo = new PDO('mysql:host=localhost;dbname=painelcms','root','');
...
<html lang="en">
  <head>
    ...
    <title>Painel Danke Web CMS</title>
    <!-- Bootstrap -->
    ...
    <nav class="navbar navbar-fixed-top navbar-default">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="#">Danke Web</a>
        </div>
    ...
    <section class="principal">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-9">
                <!--FUNCAO DO SOBRE E CADASTRAR EQUIPE-->
                <?php
                ...
                ?>
                  <!--FUNCAO SOBRE DO DO PAINEL COM DB -->
